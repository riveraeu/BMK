<template>
  <div class="container mx-auto py-20 px-6 sm:px-0 local-experts">
    ...
    <div class="pdf  mb-4">
      <a href="https://res.cloudinary.com/rivera-web-solutions/image/upload/v1565923955/BMK/MR_pdf.pdf" target="_blank">View PDF</a>
    </div>
    <a v-for="(page, index) in marketReport" :key="index"
     href="https://res.cloudinary.com/rivera-web-solutions/image/upload/v1565923955/BMK/MR_pdf.pdf" target="_blank">
